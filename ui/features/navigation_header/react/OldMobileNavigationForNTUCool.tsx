...
const MobileGlobalMenu = React.lazy(() => import('./OldMobileGlobalMenuForNTUCool'))

const MobileNavigation: React.FC<{navIsOpen?: boolean, externalTools?: Array<ExternalTool>}> = ({navIsOpen = false, externalTools = []}) => {
        ...
        >
          {globalNavIsOpen && (
            <React.Suspense fallback={spinner}>
              <MobileGlobalMenu onDismiss={() => setGlobalNavIsOpen(false)} externalTools={externalTools}/>
            </React.Suspense>
          )}
        </Tray>
      )}
